...
module.exports = (sequelize, DataTypes) => {
  class dba_hmrc_export_gen extends Model {
    /**
  ...
  dba_hmrc_export_gen.init({
 
    company_id: DataTypes.INTEGER,
    dba_hmrc_exp_id: DataTypes.INTEGER,
    ...
    sequelize,
    modelName: 'dba_hmrc_export_gen',
  });
  return dba_hmrc_export_gen;
};