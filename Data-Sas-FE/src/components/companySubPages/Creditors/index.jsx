...
const Creditors = () => {
    ...
    return (
        ...
        <>
            <div>
                <Typography variant="h5" style={{ fontWeight: 600 }} className={classess.creditorsHeading}>Creditors</Typography>
                ...
                <Grid container className={classess.directorCard} >
                    ...
                    <Grid item style={{marginLeft:"20px"}}>
                        <DirectorCard  count="$0" message="Creditor Count" imgsrc="/images/money-bag.png"/>
                    </Grid>
                </Grid>
