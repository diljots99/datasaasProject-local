...
export default function Table({
  ...
  return (
    <div className="main">
      ...
      <table class="role-header" id="table-to-xls" {...getTableProps()} className={classess.impactTable}>
        {/* Table Head */}
        {headerGroups.map((headerGroup) => (
          <tr {...headerGroup.getHeaderGroupProps()}>
            {headerGroup.headers.map((column) => {
              return (
                <th style={{ fontFamily: "Poppins" , fontSize: "22px" , lineHeight: "33px" , fontWeight: "600" , color: "#000"}}
                  className={
                    column.Header === "Company Number"
                      ? "borderStart"
                      : column.Header === "Date"
                        ? "borderEnd"
                        : "borderCenter"
              ...
              {row.cells.map((cell) => {
                ...
                return (
                  <td
                    ...
                    className={
                      cell.column.Header === "Company Number"
                        ? "borderStart"
