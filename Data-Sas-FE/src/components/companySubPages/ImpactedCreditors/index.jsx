...
const ImpactedCreditors = () => {
    ...
    return (
        ...
        <>
            <div>
                <Typography variant="h5" style={{ fontWeight: 600 }} className={classess.impactHeading}>Impacted Creditors</Typography>

                <Grid container className={classess.directorCard} >
                    <Grid item>

                        <DirectorCard  count="$0" message="Total Amount" imgsrc="/images/money-bag.png"  style={{background: "#D9EEFE"}}/>
                    </Grid>
                    <Grid item style={{marginLeft:"20px"}}>
                        <DirectorCard  count="$0" message="Creditor Count" imgsrc="/images/money-bag.png" style={{background: "#E1DAFC"}}/>
                    </Grid>
                </Grid>
...
export default ImpactedCreditors;