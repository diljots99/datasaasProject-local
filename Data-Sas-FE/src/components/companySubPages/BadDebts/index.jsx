...
const BedDebts = () => {
    ...
    return (
        ...
        <>
            <div>
                <Typography variant="h5" style={{ fontWeight: 600 }} className={classess.debtsHeading}>Bed Debts</Typography>
                ...
                <Grid container className={classess.directorCard} >
                    ...
                    <Grid item style={{marginLeft:"20px"}}>
                        <DirectorCard  count="$0" message="Bed Debts Count" imgsrc="/images/money-bag.png"/>
                    </Grid>
                </Grid>
