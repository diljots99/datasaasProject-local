  ...
  return (
    <div className="main">
      <div className="tableWrap" className={classess.tableWrap}>
        <table class="role-header" id="table-to-xls" {...getTableProps()} className={classess.relatedperTable}>
          {/* Table Head */}
                ...
                {row.cells.map((cell) => {
                  ...
                  return (
                    <td
                      ...
                      className={
                        cell.column.Header === "Person Name"
                          ? "borderStart"
                          : cell.column.Header === "Website"
                          ? "borderEnd"
                          : "borderCenter"
                      }
                      {...cell.getCellProps()}
