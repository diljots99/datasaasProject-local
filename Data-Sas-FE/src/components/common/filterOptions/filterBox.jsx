...
export const FilterBox = () => {
  ...
  const { isopen, selectedFilterValues, filterTypeDetail } = useSelector(
    (state) => state.filter
  );
  // Open / Close filters
  ...
  const handleSearchFilter = () => {
    ...
    dispatch(getFilterSearchResults(req, handleClose, history));
  };
  ...
  return (
    <div>
      ...
      >
        <BiIcons.BiMenuAltRight className="FilterMenuIcon" size={"40px"} />
          ...
          <div className="filtersBox">
              ...
              <FiltersWrap>
                {filtersData.map((item, index) => {
                  return (
                    <SubFilter
                      item={item}
                      setSubFilterOptionsHeading={setSubFilterOptionsHeading}
                      setSubFilterOptions={setSubFilterOptions}
                      key={index}
            ...
            <div className="clearFiltersContainer">
              ...
              <div className="clearFiltersContainerButtons">
                <button
                  className="clearFilterSave"
                  onClick={() => setShowSave(true)}
                >
                  Save
                </button>
                <button className="clearFilterSearch" onClick={() => handleSearchFilter()} >Search</button>
              </div>
            </div>
          </div>
        </Box>
