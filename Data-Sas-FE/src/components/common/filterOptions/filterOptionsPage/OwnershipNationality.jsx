...
export default function OwnershipNationality() {
  ...
  const getOptions = () => {
    ...
    let filtervalue = filterTypeDetail.filter(value => value.name ===  "Ownership Nationality" &&  value.category === "Ownership")
    if (filtervalue) {
  ...
  const applyFilter = () => {
    ...
    if( selectedOption !==null && selectedOption.length > 0){
      ...
      dispatch(SetselectedFilterValues("Ownership Nationality", filterval))
      ...
      {isEnabled ? <>
       <div className="searchContainer">
         <Select
           ...
           placeholder="Ownership Nationality"
