...
export default function OwnershipCountryofResidence() {
  ...
  const getOptions = () => {
    let filtervalue = filterTypeDetail.filter(
      (value) =>
        value.name === "Ownership Country of Residence" &&
        value.category === "Ownership"
    );
    if (filtervalue) {
  ...
  const applyFilter = () => {
    if (selectedOption !== null && selectedOption.length > 0) {
      ...
      dispatch(
        SetselectedFilterValues("Ownership Country of Residence", filterval)
      );
        ...
        <>
          <div className="searchContainer">
            <Select
              ...
              placeholder="Country of Residenc"
