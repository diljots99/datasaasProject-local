...
export default function DirectorNationality() {
  ...
  const getOptions = () => {
    ...
    let filtervalue = filterTypeDetail.filter(value => value.name ===  "Director Nationality" &&  value.category === "Directors")
    if (filtervalue) {
  ...
  const applyFilter = () => {
    ...
    if( selectedOption !==null && selectedOption.length > 0){
      ...
      dispatch(SetselectedFilterValues("Director Nationality", filterval))
