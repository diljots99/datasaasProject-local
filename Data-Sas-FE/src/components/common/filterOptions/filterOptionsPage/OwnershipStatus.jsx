...
export default function OwnershipStatus() {
  ...
  const getOptions = () => {
    ...
    let filtervalue = filterTypeDetail.filter(value => value.name === "Ownership Status" &&  value.category === "Ownership")
    if (filtervalue) {
  ...
  const applyFilter = () => {
    ...
    if( selectedOption !==null && selectedOption.length > 0){
      ...
      dispatch(SetselectedFilterValues("Ownership Status", filterval))
