...
export default function DirectorRole() {
  ...
  const getOptions = () => {
    ...
    let filtervalue = filterTypeDetail.filter(value => value.name ===  "Director Role" &&  value.category === "Directors")
    if (filtervalue) {
  ...
  const applyFilter = () => {
    ...
    if( selectedOption !==null && selectedOption.length > 0){
      ...
      dispatch(SetselectedFilterValues("Director Role", filterval))
